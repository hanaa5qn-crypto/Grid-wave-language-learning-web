...
export default function IeltsHomeTab({ onGo }: { onGo: (tab: IeltsTabKey) => void }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-10">
      <section className={gold || aurora ? "rounded-3xl bg-surface-container p-7 sm:p-9" : "rounded-3xl bg-ink-raise p-7 sm:p-9"}>
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          ...
          <button
            ...
            className={gold || aurora ? "inline-flex items-center gap-2 rounded-full bg-surface-container-high text-on-surface px-6 py-3 font-bold hover:bg-surface-container-high" : "inline-flex items-center gap-2 rounded-full bg-ink-2 text-paper px-6 py-3 font-bold hover:bg-ink-raise"}
          >
      ...
      <section>
        <h2 className={gold || aurora ? "text-xl font-bold text-on-surface mb-4" : "text-xl font-bold text-paper mb-4"}>The four skills · Дөрвөн ур чадвар</h2>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        <div className={gold || aurora ? "rounded-2xl bg-surface-container p-6" : "rounded-2xl bg-ink-raise p-6"}>
          <h2 className={gold || aurora ? "font-bold text-on-surface flex items-center gap-2" : "font-bold text-paper flex items-center gap-2"}>
            <Award className={gold || aurora ? "w-5 h-5 text-on-surface" : "w-5 h-5 text-paper"} /> Band scale 0–9
          </h2>
          ...
          <ul className={gold || aurora ? "mt-3 space-y-1.5 text-sm text-on-surface" : "mt-3 space-y-1.5 text-sm text-paper"}>
            <li><span className={gold || aurora ? "font-bold text-on-surface" : "font-bold text-paper"}>9.0</span> — Expert: бараг төгс</li>
            <li><span className={gold || aurora ? "font-bold text-on-surface" : "font-bold text-paper"}>7.0</span> — Good: сайн, цөөн алдаатай</li>
            <li><span className={gold || aurora ? "font-bold text-on-surface" : "font-bold text-paper"}>6.0</span> — Competent: ерөнхийдөө ойлгомжтой</li>
            <li><span className={gold || aurora ? "font-bold text-on-surface" : "font-bold text-paper"}>5.0</span> — Modest: суурь чадвартай</li>
          </ul>
        </div>
        <div className={gold || aurora ? "rounded-2xl bg-surface-container p-6" : "rounded-2xl bg-ink-raise p-6"}>
          <h2 className={gold || aurora ? "font-bold text-on-surface flex items-center gap-2" : "font-bold text-paper flex items-center gap-2"}>
            <GraduationCap className={gold || aurora ? "w-5 h-5 text-on-surface" : "w-5 h-5 text-paper"} /> Academic vs General
          </h2>
          <p className={gold || aurora ? "text-on-surface-variant text-sm mt-2" : "text-paper-2 text-sm mt-2"}>
