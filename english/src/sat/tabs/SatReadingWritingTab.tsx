...
// colliding with the test questions when both are listed). Grouped by domain
// (official testing order), Easy → Medium → Hard within each.
...
export default function SatReadingWritingTab({ allContent, onUpgrade }: { allContent: boolean; onUpgrade: () => void }) {
  ...
  // 20001-20098, 30001-30098, 40001-40098 (clear of drills 90001+/91001+, gen 93001+).
