...
export const READING_LESSON: ReadingExercise = {
  title: 'Өөрийгөө танилцуулах (Sich vorstellen)',
  level: 'A1 • ТҮВШИН',
  germanText: 'Hallo! Ich heiße Anna. Ich bin zweiundzwanzig Jahre alt. Ich komme aus der Mongolei, aber ich wohne jetzt in Berlin. Ich lerne Deutsch, weil ich hier studieren möchte. Deutsch ist eine schöne Sprache.',
  paragraphs: [
    'Hallo! Ich heiße {Anna}. Ich bin zweiundzwanzig {Jahre} alt.',
    'Ich komme aus der {Mongolei}, aber ich wohne jetzt in {Berlin}.',
    'Ich lerne {Deutsch}, weil ich hier studieren möchte. Deutsch ist eine schöne Sprache.'
  ],
  vocabHighlights: {
    Anna: {
      word: 'Anna',
      translation: 'Анна (хүний нэр)',
      grammar: 'Eigenname (Эрэгтэй/Эмэгтэй нэр)'
    },
    Jahre: {
      word: 'Jahre',
      translation: 'Нас / Жил',
      grammar: 'Plural (Олон тоо)'
    },
    Mongolei: {
      word: 'Mongolei',
      translation: 'Монгол улс',
      grammar: 'Feminin, Dativ (Эмэгтэй хүйс, өгөх оршихын тийн ялгал)'
    },
    Berlin: {
      word: 'Berlin',
      translation: 'Берлин хот',
      grammar: 'Stadtname (Хотын нэр)'
    },
    Deutsch: {
      word: 'Deutsch',
      translation: 'Герман хэл',
      grammar: 'Sprache (Хэл)'
    }
  },
  quizQuestion: 'Анна одоо хаана амьдардаг вэ (Wo wohnt Anna)?',
  quizChoices: [
    'Sie wohnt in Ulaanbaatar.',
    'Sie wohnt in Berlin.',
    'Sie wohnt in München.'
  ],
  correctChoiceIndex: 1,
  hint: 'Санамж: "...aber ich wohne jetzt in Berlin."'
};
...
export const LISTENING_LESSON: ListeningExercise = {
  sentence: 'Ich komme aus der Mongolei.',
  wordChips: ['der', 'Mongolei', 'Ich', 'aus', 'komme'],
  correctOrder: ['Ich', 'komme', 'aus', 'der', 'Mongolei'],
  transcription: 'Сонсоод, өгүүлбэрийг зөв дараалалд оруулна уу (A1)'
};
...
export const SPEAKING_LESSON: SpeakingExercise = {
  sentence: 'Wie geht es Ihnen?',
  phonetics: '/viː ˈɡeːt ɛs ˈiːnən/',
  translation: 'Таны бие сайн байна уу?'
};
...
export const WRITING_LESSON: WritingExercise = {
  prompt: '"Миний нэрийг Бат гэдэг."',
  targetSentence: 'Mein Name ist Bat.',
  grammarTipTitle: 'Нэрээ хэрхэн хэлэх вэ? (A1)',
  grammarTipContent: 'Герман хэлэнд өөрийн нэрийг хэлэхдээ "Mein Name ist [Нэр]" (Миний нэр бол ...) эсвэл "Ich heiße [Нэр]" (Намайг ... гэдэг) гэсэн бүтцийг ашигладаг. "Name" гэдэг нэр үгийн эхний үсэг томоор бичигддэг болохыг анхаарна уу.',
  sentenceStructure: 'Mein Name + ist + [Нэр]',
  exampleChips: ['Mein', 'Name', 'ist', 'Bat']
};
