 ...
 */
export default function AuroraLoginScreen({ inviteContext, onBack, onGuest, initialMode }: LoginScreenProps = {}) {
              ...
              {onGuest && (
                <div className="pt-3">
                  ...
                  <button
                    type="button"
                    onClick={onGuest}
                    className="w-full bg-transparent hover:bg-white/5 text-slate-300 hover:text-white font-semibold py-3 px-6 rounded-xl border border-white/15 hover:border-white/30 transition-colors cursor-pointer"
                  >
